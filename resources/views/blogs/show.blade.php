...
@section("content")
    <div class="pt-10">
      ...
      <div class="flex items-center justify-between text-sm mb-6">
        <span class="mr-4"
          ...
          ></span
        >
        <span class="mr-4">Published on <span>{{ $blog->created_at->format('M j, Y') }}</span></span>
        <span class="mr-4"><span>{{ $blog->read_time }} mins read</span></span>
    ...
    <section class="bg-gray-100 dark:bg-gray-900 py-4">
      ...
      >
        ...
        <div class="p-4 border border-gray-300 rounded-lg shadow-md mb-2">

            @if (count($blog->sample_comments) > 0)
                @foreach($blog->sample_comments as $comment )
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <!-- Blog Card 3 -->
      <a href="#" class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
        <img src="https://via.placeholder.com/400x200" alt="Blog 3" class="w-full h-48 object-cover">
        <div class="p-4">
          <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">
            The Future of Blogging in 2024
          </h3>
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
            Discover emerging trends that will shape the blogging world next year.
          </p>
          <span class="text-indigo-600 dark:text-indigo-400 text-sm font-medium block mt-4">Read More →</span>
        </div>
      </a>
